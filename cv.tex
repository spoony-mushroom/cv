...
\section{Experience}
    ...
    \datedexperience{wrnch, Inc.}{Mar 2015 - Jul 2021} 
     ...
     \coloredbullet\ %
      ...
      \smallskip
      \coloredbullet\ %
      Designed tech stack for real-time vision-based human motion capture, integrating wrnch's deep learning modules with various front-end applications (Python, C++, Unity, Unreal 4, web).
